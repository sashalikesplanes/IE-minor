...
function createMessageBehaviourHandler(key) {
    ...
    const middleEvents = (0, mappers_1.mapNodeListToConstantEvents)([...nodeSet], config_1.NODE_COLOR, totalDuration, config_1.NODE_SOLID_WIDTH, config_1.MESSAGE_FADE_DURATION, 0, config_1.MESSAGE_FADE_POWER);
    ...
    return function (nodePair) {
        ...
        if (new Date().getTime() - lastDispatchTime >
            totalDuration * config_1.MESSAGE_FADE_IN_TIMEOUT_MULTIPLIER) {
...
function createSingleBehaviourHandler(nodeIdx) {
    ...
    return function (nodeList) {
        ...
        if (new Date().getTime() - lastMessageTime > config_1.SINGLE_LED_DURATION) {
